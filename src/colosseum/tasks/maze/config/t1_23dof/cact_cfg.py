...
from colosseum.tasks.maze.mdp.abstraction.abstraction_velocity_command import (
...
from colosseum.tasks.maze.mdp.abstraction.goal_command import MazeGoalCommandCfg
